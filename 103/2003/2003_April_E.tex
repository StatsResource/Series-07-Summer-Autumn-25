...
9 (i) We need to prove that E(Yn+1X1, X2, Xn) = Yn.
We have
...
E(Zn+1X1, X2, , Xn) = Sn2  2np = Zn , so that {Zn} is a martingale. (b) The conditions of the optional stopping theorem are not satisfied, since
2 2 Sn np  is not bounded below for 0  n  T. But we can work with a truncated stopping time TK = min(T, K), for which the conditions of the
