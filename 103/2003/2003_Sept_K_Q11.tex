...
process. [2]
(ii) Suppose that a Markov jump process model is to be fitted to the data set above. List all the parameters of the model and discuss the assumptions made
...
holding time in state i and of anything that happened before the chain arrived in state i.
(iii) 1
...
0.375 1.5 1.125
1.75 0.25 2
(iv) One test should test whether the holding times in each state are exponentially distributed. If Ti,k denotes the kth holding time in state i, then the hypothesis is that Ti,1, Ti,2, , Ti,ni is a sample from an exponential distribution with
