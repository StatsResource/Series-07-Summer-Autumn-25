...
2 Let (X1, X2, … , X9) be a random sample from a N(0,2) distribution. Let X and
...
table. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
3 A random sample of size 200 is taken from a large group of motor policies. The
...
group of policies. 
4 A random sample of 16 values, x1, x2,  , x16, was drawn from a normal population
