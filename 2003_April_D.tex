...
\item (a) Construct a suitable 2  4 contingency table, and calculate the overall
proportion of girls.
...
\item (ii) (a) Suggest a model (with all parameter values stated or estimated) for the
number of girls in a family, for each family size (1, 2, 3, and 4), using
your conclusion from part (i).
\item (b) Suppose the researcher was to test the goodness-of-fit of the models
...
would interpret this lack of fit. 
\end{enumerate/}
...
\item (b) The model assumes that the trials are independent i.e. that the gender
of each child is independent of that of all other children in the family.
\item We would interpret the lack of fit as evidence that the genders of
children in a family are not independently determined.
\item In addition, the gender of the first child (or the genders of the first and
