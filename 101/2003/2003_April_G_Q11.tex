...
\begin{document} 11 Let S  X1  X2 ... XN (and S = 0 if N = 0) where the Xi s are independent and identically distributed as exponential random variables with mean  and are also independent of N, which has a Poisson distribution with mean .
\begin{enumerate}[(a)]
