...
(d) Show that the maximum likelihood estimator of $\beta$ has variance equal to the lower bound given in (i)(c). 
...
   .
(ii) Determine the approximate maximum likelihood estimates of $\beta$ and $m$, substituting g(m) for $\Gamma(m)$ in the likelihood function. 
(iii) Suppose that the sample values are:
\[32 48 51 43 82 155\]
Obtain the approximate maximum likelihood estimates for $\beta$ and $m$ given in (ii). 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item A social researcher is interested in the gender distribution among children in families, and has collected data for her investigation as follows.
