...
\begin{document}Faculty of Actuaries Institute of Actuaries
EXAMINATIONS
...
1 A random sample of fifty claim amounts (£) arising in a particular section of an
...
2 Consider a random sample of 47 white-collar workers and a random sample of 24 blue-collar workers from the workforce of a large company. The mean salary for
