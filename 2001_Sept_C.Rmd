...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
9 Two independent random samples of sizes n1 and n2 are selected from a normal
population with variance σ2. The sample variances are denoted by 2
S1 and 2
S2
respectively. Let 2W
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
10 The number of incomplete insurance proposals Y, in a batch of x proposals, is to
be modelled as a Poisson random variable with mean \lambdax, where \lambda is unknown.
...

 . 
\item Determine \lambda , the maximum likelihood estimator of \lambda. 
\item Determine whether neither, one, or both of \lambda and \lambda provide unbiased
estimators of \lambda. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
11 A random sample of 11 policies on the contents of private houses was examined
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
12 Claims are classified on inception into one of three categories, simple,
...
Therefore 2
W S is unbiased for 2. MSE = ( 2 ) W Var S since unbiased.
...
11 \item 129.1 + 109.8 + 123.5 = 362.4 , 1,534.37 + 1,109.88 + 1,401.73 = 4,045.98
...
Residual 30 48.24 1.61
32 66.17
\item  F = 8.97/1.61 = 5.57 on 2,30 d.f.
