...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
5 The number of claims, X, to be processed in a day by an employee of an insurance company is modelled as X ~ Poisson with mean 10. The time (minutes) the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
6 \item The occurrence of claims in a group of 200 policies is modelled such that
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
8 A job takes X minutes to complete, where X is modelled as a N(28,22) random
...
= E(X) + 12 + [152  V(X)]
= 10 + 12 + 225(10) = 2272
6 \item X = number of claims arising
...
\item X = number of claims arising X ~ binomial with n = 2000, p = 0.015
